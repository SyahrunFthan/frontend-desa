...
import { residentUpdated } from "../../services/resident";
...
const ResidentEdit = ({
  ...
  const handleSubmit = (values: ResidentModel) => {
    let formData = new FormData();

    if (values.profesion_status == false) {
      form.resetFields(["profesion"]);
    }
    ...
    if (values.profesion !== undefined) {
      ...
      formData.append("profesion", values.profesion ?? null);
    }
  ...
  return (
    <Drawer open={isOpenDrawer} closable={false} title={t("residents.edit")}>
      <Form layout="vertical" form={form} onFinish={handleSubmit}>
        ...
        <Form.Item name="disable_profesion_status" hidden>
          <Input />
        </Form.Item>
        <Form.Item
